...
class SinglyLinkedList {
     ...
     */
    moveMinToFront() { 
        // this.insertAtFront(recursiveMin());
        const min = this.recursiveMin();
        this.removeVal(min);
...
const listOne = new SinglyLinkedList();
const listTwo = new SinglyLinkedList();
const listThree = new SinglyLinkedList();
...
listTwo.insertAtBack(5);
listTwo.insertAtBack(6);
listTwo.insertAtBack(0);

// listTwo.insertAtBack();

// console.log(listOne.concat(listTwo).toArr());
// console.log(listOne.concat(listThree).toArr());
// console.log(listTwo.recursiveMin());
// console.log(listTwo.insertAtFront(7));
console.log(listTwo.moveMinToFront().toArr());