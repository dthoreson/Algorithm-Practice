...
class MinHeap {
    ...
    extract() { 
        ...
        let currentIndex = 1;
        while(this.heap[idxOfLeftChild(currentIndex)] != null){
            if(this.heap[this.idxOfLeftChild(currentIndex)] < this.heap[this.idxOfRightChild(currentIndex)]){
                this.swap(currentIndex, this.idxOfLeftChild(currentIndex));
                currentIndex = this.idxOfLeftChild(currentIndex);
            } else {
                this.swap(currentIndex, this.idxOfLeftChild(currentIndex));
                currentIndex = this.idxOfRightChild(currentIndex);
            }
        }
        this.swap(currentIndex, this.size);
        this.heap.pop();
        return returnValue;
    }
